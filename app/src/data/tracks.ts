...
export const audioCatalog: Partial<Record<StoreId, Partial<Record<MoodId, Track[]>>>> = {
  ...
  mall: {
    ...
    energetic: build('mall/Energetic', [
      'F40.mp3',
      'Fresh Start.mp3',
      'Nothing To Prove - Instrumental.mp3',
      'On.mp3',
      'Poolside.mp3',
    ]),
    premium: build('mall/Premium', [
      'Angels And Demons Here.mp3',
      'August House.mp3',
      'Cala Olivera.mp3',
      "Don'T Leave.mp3",
    ...
    relaxed: build('mall/Relaxed', [
      'Chillout Jazz.mp3',
      'Congo Basin.mp3',
      'Memories of a Woman.mp3',
      'Relaxed Sunny Jazz 2.mp3',
      'Swing.mp3',
    ]),
    sophisticated: build('mall/Sophisticated', [
      'Charmed.mp3',
      'Classic Lounge.mp3',
      'Monochrome.mp3',
      'Slow Tone.mp3',
      'The Silken Victory.mp3',
    ]),
    upbeat: build('mall/Upbeat', [
      'Dreamy Fate.mp3',
      'Fireflies.mp3',
      'Inspiring Pop.mp3',
      'See Me Fall.mp3',
  ...
  hotel: {
    chill: build('hotel/Chill', [
      'Ambient Things.mp3',
      'Beautiful Siren.mp3',
      'Dream Eyes.mp3',
      'Fragile Memories.mp3',
      'Halcyon Days.mp3',
    ]),
    energetic: build('hotel/Energetic', [
      'Miracle Maker - Soldardo.mp3',
      'Move To The Rhythm - Soldardo.mp3',
      'Nothing To Prove - Instrumental.mp3',
      'Poolside.mp3',
      'transporter.mp3',
    ]),
    premium: build('hotel/Premium', [
      'Angels And Demons Here.mp3',
      'Beauty Memory.mp3',
      'So Deep House 7.mp3',
      "The Business'S Son.mp3",
      'Time Goes By.mp3',
    ]),
    relaxed: build('hotel/Relaxed', [
      'Afterhours Mood.mp3',
      'Butterflies in the Wind.mp3',
      'Memories of a Woman.mp3',
      'Paris Afterhours.mp3',
      'The Nature of Things.mp3',
    ]),
    sophisticated: build('hotel/Sophisticated', [
      'Close Enough For Jazz - Sole Collective.mp3',
      'Kobe.mp3',
      'Picture Me Better - Sole Collective.mp3',
      'airy dream.mp3',
      'balcony - lakitu.mp3',
    ]),
    upbeat: build('hotel/Upbeat', [
      'All My Love.mp3',
      'Foggy Day.mp3',
      'Follow Away (Dub).mp3',
      'Monochrome.mp3',
  ...
  supermarket: {
    chill: build('supermarket/Chill', [
      'French Polinesia 10.mp3',
      'French Polinesia.mp3',
      'Friday Calling.mp3',
      'Isla Style 3.mp3',
      'Island.mp3',
    ]),
    energetic: build('supermarket/Energetic', [
      'Beep Master.mp3',
      'Fall.mp3',
      'Go and Play.mp3',
      'Touch Your Love (Vocal mix).mp3',
      'We R Alone (Vocal mix).mp3',
    ]),
    premium: build('supermarket/Premium', [
      'Auspicious Path.mp3',
      'Capture Bird.mp3',
      'Classic Lounge.mp3',
      'Drift Away.mp3',
    ...
    relaxed: build('supermarket/Relaxed', [
      'All Night.mp3',
      'Another One.mp3',
      'Cyclone.mp3',
      'Fireflies.mp3',
    ...
    sophisticated: build('supermarket/Sophisticated', [
      "All I Need TB.mp3",
      "Baby Don't Leave.mp3",
      'Change In Me.mp3',
      'Guilty As Charged.mp3',
      "Just When I Thought I'd Seen It All.mp3",
    ]),
    upbeat: build('supermarket/Upbeat', [
      'Hit Me With Your Love.mp3',
      'Last Hope.mp3',
      'Save Me.mp3',
      'Sun Comes Up.mp3',
      'You Make Me.mp3',
  ...
  automotive: {
    chill: build('automotive/Chill', [
      'Beauty Memory.mp3',
      'Expanse.mp3',
      'Moon.mp3',
      'Moonlight.mp3',
      'Toricos - The Sun (Original Mix).mp3',
    ]),
    energetic: build('automotive/Energetic', [
      '5000 miles.mp3',
      'Deep Light House 2.mp3',
      'Magestic.mp3',
      'Romantic Summer House.mp3',
      'Sprint.mp3',
    ]),
    premium: build('automotive/Premium', [
      'Abszissenwerte.mp3',
      'Eden.mp3',
      'Miss Carinngton (Original Mix).mp3',
      'Moonlight.mp3',
      'Tranquility.mp3',
    ]),
    relaxed: build('automotive/Relaxed', [
      'Back In The Day.mp3',
      'Blown Away.mp3',
      'Dance and Fun.mp3',
      'Hippety Hoppety.mp3',
    ...
    sophisticated: build('automotive/Sophisticated', [
      'Boombox Shuffle.mp3',
      'Follow Away (Dub).mp3',
      'Painted Woof.mp3',
      'Theme For A Lazy Sunday.mp3',
      'Tumble Weed.mp3',
    ]),
    upbeat: build('automotive/Upbeat', [
      'All Night.mp3',
      'Another One.mp3',
      'Fireflies.mp3',
      'Fun.mp3',
