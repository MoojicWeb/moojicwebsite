    ...
    <footer className="relative bg-[#0a0a1a] border-t border-white/5 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-16">
          ...
          <div>
            <h4 className="text-white text-xs font-semibold uppercase tracking-[0.1em] mb-5">Services</h4>
            <ul className="space-y-3">
              {serviceLinks.map((link) => (
                <li key={link.path}>
                  <Link to={link.path} className="text-white hover:text-[#e91e63] text-sm transition-colors">{link.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-white text-xs font-semibold uppercase tracking-[0.1em] mb-5">Company</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-white text-xs font-semibold uppercase tracking-[0.1em] mb-5">Contact</h4>
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white text-xs">Copyright © 2025 Moojic. All rights reserved.</p>
          <p className="text-white text-xs">Powered by Adonta Mobility Solutions</p>
        </div>
      </div>
    </footer>
  );
